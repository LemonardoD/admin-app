...
import './VerticalBarFunnel.css';

interface VerticalBarFunnelProps {
  data: FunnelData[];
}

export default function VerticalBarFunnel({
  data
}: VerticalBarFunnelProps) {
    ...
    <div className="vertical-bar-funnel">
      ...
      <div className="vbf-chart">
        <div className="vbf-bars-container">
          ...
          <svg className="vbf-background-area" viewBox="0 0 800 400" preserveAspectRatio="none">
          ...
          <div className="vbf-bars">
            {stepsWithPercent.map((step) => {
              ...
              return (
                <div key={step.label} className="vbf-bar-wrapper">
                  <div className="vbf-bar-value">
